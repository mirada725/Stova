...
function HotelCard(props) {
  return (
    <Link
      ...
      key={props.hotel._id}
      className="block group relative bg-slate-500/10 opacity-90 rounded-xl p-1"
    >
      <div className="relative aspect-[4/3] overflow-hidden rounded-xl">
        <img
          src={props.hotel.image}
          alt={props.hotel.name}
          className="object-cover w-full h-full absolute transition-transform duration-500 group-hover:scale-110"
        />
      </div>
